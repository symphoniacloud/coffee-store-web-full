...
// Replace this map with your own (or set to an empty map)
var manualRedirects = {
    "/symphonia":"https://symphonia.io",
}

// Change this if you want to use a default object name
...
function handler(event) {
    ...
    // If the request matches an entry in our "manualRedirects" map, then use that
    ...
    if (uri.match(/.+\/$/))
        return createRedirect(uri.slice(0, -1))
